...
public class FixedAssetActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("固定资产管理");
    ...
    private void setDate() {
    	menuList.clear();
    	MenuItem mi;
    	mi=new MenuItem(R.drawable.ic_gdzcgr,"购入固定资产/报销待摊费用",String.valueOf(NavigationActivity.task[17]));
        menuList.add(mi);
        mi=new MenuItem(R.drawable.ic_gdzccz,"处置固定资产",String.valueOf(NavigationActivity.task[18]));
        menuList.add(mi);
    ...
    private class ItemClickEvent implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            ...
            if (m.getContent().equals("购入固定资产/报销待摊费用")){
