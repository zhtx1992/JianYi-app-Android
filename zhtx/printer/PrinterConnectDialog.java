...
import com.zhtx.app.adapter.ListViewAdapter;
...
public class PrinterConnectDialog extends Activity {
	...
	private void initPortParam() {
		...
		boolean[] state = intent.getBooleanArrayExtra(PrintActivity.CONNECT_STATUS);
			...
			if (CheckPortParamters(mPortParam[PrinterId])) {
				...
				case PortParameters.USB:
					try {
						...
						PrintActivity.targetPrint=PrinterId;
					} catch (RemoteException e) {
